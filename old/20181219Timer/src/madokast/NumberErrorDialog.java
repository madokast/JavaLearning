...
public class NumberErrorDialog extends Dialog {
    private static NumberErrorDialog numberErrorDialog;
    public static NumberErrorDialog getInstance()
    {
        if(numberErrorDialog==null)
        {
            numberErrorDialog = new NumberErrorDialog();
        }

        return numberErrorDialog;
    }


    private NumberErrorDialog()
    {
        super(WindowFrame.getInstance(),"Number Error",true);
        ...
        this.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                if(e.getKeyCode()==KeyEvent.VK_ENTER)
                    NumberErrorDialog.getInstance().setVisible(false);
            }
        });
