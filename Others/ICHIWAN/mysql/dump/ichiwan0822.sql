...
INSERT INTO `test` VALUES ('2019-08-22',52),('2019-07-02',1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger period before insert on test for each row
    begin
...
-- Dump completed on 2019-08-22  8:20:03
